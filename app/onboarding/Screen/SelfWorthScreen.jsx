...
export default function SelfWorthScreen() {
      ...
      <View style={{paddingTop:50, flex: 1 }}>
        <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 100 }} keyboardShouldPersistTaps="handled">
          ...
          <View style={{ backgroundColor: '#E5E0FF', padding: 18, borderRadius: 16, marginBottom: 20 }}>
            <Text style={{ fontSize: 22, fontWeight: '800', color: '#4A3AFF' }}>Self-Worth</Text>
          ...
          <View style={{
            ...
            <TextInput
              multiline
              placeholder="What do you value most about yourself..."
